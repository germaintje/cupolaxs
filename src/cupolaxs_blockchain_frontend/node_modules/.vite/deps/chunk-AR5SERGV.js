...
var HttpAgent = class _HttpAgent {
  constructor(options = {}) {
    ...
    this._retryTimes = (_a2 = options.retryTimes) !== null && _a2 !== void 0 ? _a2 : 3;
...
`;
  ...
  async query(canisterId, fields, identity) {
    ...
    const makeQuery = async () => {
      ...
      return await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetryQuery).call(this, args);
    };
    ...
    try {
      return __classPrivateFieldGet4(this, _HttpAgent_verifyQueryResponse, "f").call(this, query, subnetStatus);
    } catch (_) {
      ...
      return __classPrivateFieldGet4(this, _HttpAgent_verifyQueryResponse, "f").call(this, query, updatedSubnetStatus);
    }
  }
...
`);
    ...
    if (parsedTime > 0) {
      ...
      __classPrivateFieldSet3(this, _HttpAgent_waterMark, parsedTime, "f");
    }
  ...
  async syncTime(canisterId) {
    const CanisterStatus = await import("./canisterStatus-FHR4U5AO.js");
...
_HttpAgent_waterMark = /* @__PURE__ */ new WeakMap(), _HttpAgent_queryPipeline = /* @__PURE__ */ new WeakMap(), _HttpAgent_updatePipeline = /* @__PURE__ */ new WeakMap(), _HttpAgent_subnetKeys = /* @__PURE__ */ new WeakMap(), _HttpAgent_verifyQuerySignatures = /* @__PURE__ */ new WeakMap(), _HttpAgent_verifyQueryResponse = /* @__PURE__ */ new WeakMap(), _HttpAgent_instances = /* @__PURE__ */ new WeakSet(), _HttpAgent_requestAndRetryQuery = async function _HttpAgent_requestAndRetryQuery2(args, tries = 0) {
  var _a2, _b2;
...
`, {
  ...
  ${error}
  Retrying query.`);
      return await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetryQuery2).call(this, args, tries + 1);
    }
    throw error;
  }
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-AR5SERGV.js.map
